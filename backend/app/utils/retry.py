"""
API retry mechanism.
Used to handle retry logic for external API calls such as LLM requests.
"""
...
class RetryableAPIClient:
    ...
    def call_batch_with_retry(
        ...
        """
        Call in batch and retry each failed item individually.
        
        Args:
            items: List of items to process
            process_func: Processing function, accepts a single item
            exceptions: Exception types to retry
